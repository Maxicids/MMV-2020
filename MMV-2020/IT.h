...
#define INT_DEFAULT 0x00000000															// значение по умолчанию дл€ типа integer
#define STR_DEFAULT	0x00																// значение по умолчанию дл€ типа string
...
{
	enum IDDATATYPE { INT = 1, STR = 2, BOOL = 3, UNKNOWN };						// типы данных идентификаторов: integer, string, bool, неопределенный
	enum IDTYPE {
